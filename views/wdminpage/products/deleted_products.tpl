    ...
    <tbody>
        {foreach item=oi from=$list}
            <tr class="defTr font12">
                <td>
                    <img class='pdlist-image' src="{if $config.usecdn}{$config.imagesPrefix}product_hpic/{$oi.catimg}_x50{else}static/Thumbnail/?w=500&h=50&p={$config.productPicLink}{$oi.catimg}{/if}" />
                </td>
