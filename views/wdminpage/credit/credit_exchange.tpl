...
<div id="DataTables_Table_0_filter" class="dataTables_filter clearfix">
    <div class="button-set">
        ...
        <a class="button" data-toggle="modal" data-target="#modal_credit_exchange" data-id="0">添加</a>
    </div>
</div>
<table class="dTable">
    <thead>
...
{include file='../modal/modal_credit_exchange.html'}
{include file='../modal/modal_credit_exchange_delete.html'}
{include file='../modal/modal_credit_exchange_modify.html'}
